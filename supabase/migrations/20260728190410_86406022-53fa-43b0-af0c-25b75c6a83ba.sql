...
-- 2) storage.objects: only privileged users with AAL2 may manage exports.
...
-- A policy anterior não limitava o bucket e permitia escrita global por usuário.
-- Cada bucket de aplicação deve receber uma policy própria quando for criado.
